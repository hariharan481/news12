...
const Search1 = () => {
  ...
  const handleNeoplasmCodeClick = () => {
    setIsNeoplasmCodeClicked(true);
    setIsDrugCodeClicked(false); // Ensure drug code is not clicked
  };

  const handleDrugCodeClick = () => {
    setIsDrugCodeClicked(true);
    setIsNeoplasmCodeClicked(false); // Ensure neoplasm code is not clicked
  };
 ...
 const matches = useMediaQuery("(max-width:768px)");
  ...
  return (
    <>
      {matches ? (
        ...
        <span>
          ...
          !result1.seealso.includes("Drugs") && !result1.seealso.includes("Neoplasm") ? `seealso:${result1.seealso}` : ''}
          {result1.seealso !== 'null' && result1.seealso !== undefined &&
          !result1.seealso.includes("Drugs") && result1.seealso.includes("Neoplasm") ? (
            <span
              style={{
                borderBottom: '1px solid blue',
                cursor: 'pointer',
              }}
              onClick={() => handleNeoplasmCodeClick()}
            >
          ...
          !result1.see.includes("Drugs") && !result1.see.includes("Neoplasm") ? `see:${result1.see}` : ''}
          {result1.see !== 'null' && result1.see !== undefined &&
          !result1.see.includes("Drugs") && result1.see.includes("Neoplasm") ? (
            <span
              style={{
                borderBottom: '1px solid blue',
                cursor: 'pointer',
        ...
        <div>
          {/* Content to display when the drug code is clicked */}
   mani
        </div>
      )}
        {isDrugCodeClicked&& (
   ...
   hari
        ...
        <div>
          {/* Content to display when the drug code is clicked */}
          This is the content displayed when the drug code is clicked.
        </div>
      )}
      <Main  selectedItem={selectedItem}  isValueSelected={isValueSelected}
